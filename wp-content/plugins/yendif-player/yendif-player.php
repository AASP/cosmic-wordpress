 ...
 * Description:A HTML5 and Flash Media Player Plugin That Gives You Superior Control
 * Version:2.1
...
if ( ! defined( 'YENDIF_PLAYER_PLUGIN_VERSION_NUM' ) ) {
    define( 'YENDIF_PLAYER_VERSION_NUM', '2.0' );
}
...
add_action( 'plugins_loaded', array( 'Yendif_Player_Install', 'update_db_check' ) );
